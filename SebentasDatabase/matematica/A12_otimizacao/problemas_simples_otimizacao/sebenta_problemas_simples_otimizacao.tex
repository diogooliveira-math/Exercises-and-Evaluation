...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{Módulo A10 - Otimização}
\fancyhead[R]{problemas simples otimizacao}
\fancyfoot[C]{\thepage}
...
\subexercicio{Calcula o ângulo $\alpha$ (em graus). Usa a calculadora para encontrar $\arctan$.}
