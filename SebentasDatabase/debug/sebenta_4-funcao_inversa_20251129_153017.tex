...
\textbf{Injetividade:}
Uma função é injetora se f(x$_{1}$) = f(x$_{2}$) $\\Rightarrow$ x$_{1}$ = x$_{2}$.
...
\begin{enumerate}[label=\alph*]
    ...
    \begin{tikzpicture}[scale=0.8]
        ...
        % axes
        \draw[->,thick] (-6.5,0) -- (6.8,0) n\node[right] {$x$};
        \draw[->,thick] (0,-6.5) -- (0,6.8) n\node[above] {$y$};
        % origin
        \fill (0,0) circle (0.05) n\node[below left=2pt,fill=white,inner sep=1pt] {\small $0$};
    \end{tikzpicture}
    \end{center}
\end{enumerate}
\FloatBarrier
...
\begin{enumerate}[label=\alph*]
    ...
    \begin{tikzpicture}[scale=0.8]
        ...
        \draw[->,thick] (0,-6.5) -- (0,6.8) n\node[above] {$y$};
        % origin
        \fill (0,0) circle (0.05) n\node[below left=2pt,fill=white,inner sep=1pt] {\small $1$};
    \end{tikzpicture}
    \end{center}
\end{enumerate}
\FloatBarrier
