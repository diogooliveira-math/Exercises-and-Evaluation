...
\begin{enumerate}
\item[(a)] Represente os quatro primeiros termos da sucessao ($Q_1, Q_2, Q_3, Q_4$) em sistema hexadecimal.
\item[(b)] Escreva o 5º termo da sucessao ($Q_5$) em notacao decimal e binaria.
\item[(c)] Determine o 8º termo da sucessao ($Q_8$) e represente-o em sistema hexadecimal.
\item[(d)] Escreva a regra geral para gerar o proximo termo da sucessao dos numeros quadrados.
\end{enumerate}
