...
\exercicio
Na figura está representado o gráfico de uma função $f$ definida em $[1, +\infty[$. Represente, no referencial dado, o gráfico da função inversa $f^{0}$.
...
\begin{tikzpicture}[scale=0.8]
    ...
    \node[anchor=south west] at (axis cs:2,2.2) {$(3,3)$};
    \node[anchor=north east] at (axis cs:0.2,0.2) {$(1,1)$};
    \end{axis}
\end{tikzpicture}
\end{figure}
...
\exercicio
Na figura está representado o gráfico de uma função $g$ definida em $[2, +\infty[$. Represente, no referencial dado, o gráfico da função inversa $g^{0}$.
...
\begin{tikzpicture}[scale=0.8]
    ...
    \node[anchor=south west] at (axis cs:3,3.2) {$(4,4)$};
    \node[anchor=north east] at (axis cs:1.15,1.1) {$(2,2)$};
    \end{axis}
\end{tikzpicture}
\end{figure}