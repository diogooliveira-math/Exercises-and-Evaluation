% Exercício 2: Dada o gráfico de um ramo da função quadrática, depois desenhar o gráfico da função inversa.
...
\begin{tikzpicture}[scale=0.8]
    ...
    % Linha y=x tracejada e um pouco mais visível
...
\exercicio
Na figura está representado o gráfico de uma função $g$ definida em $[1, +\infty[$. Represente, no referencial dado, o gráfico da função inversa $g^{-1}$.
...
\begin{tikzpicture}[scale=0.8]
    ...
    % Gráfico da função g(x) = x para x>=1 (reta)
